/**
 * Serviço de Exportação e Importação de dados da família em formato .zip
 * 100% compatível com a árvore de diretórios do framework Salus original.
 */
...
export async function exportarParaZip(dados: DadosExportacao): Promise<Blob> {
  ...
  // Group members into Pessoas / Pets
